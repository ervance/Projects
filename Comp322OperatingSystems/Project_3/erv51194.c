...
int setup(char inputBuffer[], char *args[])
{
    ...
    do {
        printf("comp322> ");
        fflush(stdout);
        //clean out buffer to fix any leftover characters
        memset(inputBuffer, 0, MAX_COMMANDS * (sizeof inputBuffer[0]));
    ...
    token = strtok(&inputBuffer[0], delimit);
